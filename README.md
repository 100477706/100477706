...
- **MiniShell** — https://github.com/100477706/MiniShell  
  Stack: (por documentar según contenido)  
  Skills: resolución de problemas, persistencia, calidad  
  Ficha: [docs/projects.md#minishell](docs/projects.md#minishell)

- **Sistemas_Distribuidos** — https://github.com/100477706/Sistemas_Distribuidos  
  Stack: (por documentar según contenido)  
  Skills: trabajo en equipo, comunicación, diseño de soluciones  
  Ficha: [docs/projects.md#sistemas_distribuidos](docs/projects.md#sistemas_distribuidos)
...
<details>
  <summary><strong>➕ Matemáticas / Fundamentos</strong></summary>

- **Funciones_Matematicas** — https://github.com/100477706/Funciones_Matematicas  
  Nota: contiene un `.zip` (no publico demo si no es fiable).  
  Skills: pensamiento lógico, rigurosidad, calidad  
  Ficha: [docs/projects.md#funciones_matematicas](docs/projects.md#funciones_matematicas)
